...
They did (I made my prediction in the exit ticket.)
---

### I(nvestigate)

Answer these questions about the code snippet:
I answered these in the exit ticket.
...
class AI(Human):
    ...
    def analyze(self):
        print(f'The AI, {self.name}, is analyzing data.')

class Robot(AI):
    def __init__(self, name, age, occupation, intelligence_level):
        super().__init__(name, age, occupation, intelligence_level)

    def perform_task(self, task):
        print(f"The Robot, {self.name}, is doing {task}!")
...
robot1 = Robot("JoeBot", 100, "Coffee Table", 1)
robot1.analyze()
robot1.perform_task("nothing")
